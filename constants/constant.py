...
LIST_OF_PARAMS = [ParamsForBCH(4, 7), ParamsForBCH(11, 15), ParamsForBCH(7, 15), ParamsForBCH(5, 15),
                  ParamsForBCH(26, 31), ParamsForBCH(21, 31), ParamsForBCH(16, 31), ParamsForBCH(11, 31),
                  ParamsForBCH(6, 31), ParamsForBCH(57, 63), ParamsForBCH(51, 63), ParamsForBCH(45, 63),
